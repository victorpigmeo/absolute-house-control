...
Product requirements and user stories for absolute-house-control. Each
requirement lives in its own folder, named after the requirement's goal.

See [docs/requirements-process.md](../docs/requirements-process.md) for the
full structure and naming rules — start a new requirement by copying
[_template/](_template/).
